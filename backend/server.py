...
async def admin_seed(_: bool = Depends(require_admin)):
    ...
    await seed_if_empty("hero", [{"headline": "Imports are slow.", "sub_headline": "And expensive. And, honestly — OPTIONAL.", "twist_line": "OPTIONAL.", "description": "We manufacture PVC Decor Film and PETLAM. From our floor to yours.", "cta_text": "Get a Free Sample Box", "cta_link": "#contact", "cta2_text": "Beat My Import Price", "image_url": ""}])
    ...
    await seed_if_empty("categories", [
        {"name": "Membrane Door"}, {"name": "Louver / Shutter"}, {"name": "Wall Panel"}, {"name": "ACP & Cladding"}, {"name": "Partition"},
    ])
    ...
    await seed_if_empty("seo_settings", [{"title": "TopDecor — PVC Decor Film & PETLAM | Manufacturer in India", "description": "TopDecor manufactures PVC Decor Film for membrane doors, louvers, shutters and wall panels, and PETLAM for ACP, partition and cladding panel makers, in India.", "og_title": "TopDecor — PVC Decor Film & PETLAM", "og_description": "Indian manufacturer of PVC Decor Film and PETLAM.", "og_image": "/og-image.jpg", "canonical": "https://topdecor.in/"}])
