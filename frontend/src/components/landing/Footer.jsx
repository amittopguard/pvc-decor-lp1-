    ...
    <footer data-testid="site-footer" className="bg-slate-950 text-slate-300">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-12 gap-10">
        <div className="md:col-span-5">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="font-display font-bold text-white text-xl">KDIPL</div>
          ...
          <p className="mt-5 text-sm leading-relaxed text-slate-400 max-w-md">
            Premium PVC Decor Film for membrane doors and PVC Laminates 1&nbsp;mm &amp; 3&nbsp;mm for acrylic sheets. Made in India, shipped worldwide. Backed by 23+ years of industry experience.
          </p>
        </div>
        ...
        <div className="md:col-span-3">
          ...
          <ul className="mt-4 space-y-2 text-sm">
            <li><a href="#products" className="hover:text-white">PVC Decor Film</a></li>
            <li><a href="#products" className="hover:text-white">PVC Laminate 1 mm</a></li>
            <li><a href="#products" className="hover:text-white">PVC Laminate 3 mm</a></li>
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs text-slate-500">
          <div>&copy; {new Date().getFullYear()} KDIPL. All rights reserved.</div>
